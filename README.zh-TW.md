...
本專案透過桌面 App 的介面自動化個人 LINE/WhatsApp 帳號,**僅供個人自用**,依現狀提供、不附任何擔保。

- 自動化個人帳號可能**違反 WhatsApp / LINE 服務條款**,常見後果是帳號被停用。風險自負。
- **請勿**用於 spam、大量或未經請求的訊息、冒充他人,或未經同意讀取/蒐集他人訊息 —— 這些除了違反服務條款,還可能觸犯反垃圾訊息法與隱私法。
- 商業或大規模用途,請諮詢律師並改用官方 API(WhatsApp Business Cloud API、LINE Messaging API)。
